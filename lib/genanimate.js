...
(function() {
  ...
  */
  ...
  scrapeAnimate = function(config, target, callback) {
    ...
    animate_target = fs.existsSync(path.join(path.resolve(config.animate_dir), target + ANIMATE_HTML_SUFFIX)) ? path.join(path.resolve(config.animate_dir), target + ANIMATE_HTML_SUFFIX) : path.join(path.resolve(config.animate_dir), target + ANIMATE_HTML_ACTION_SUFFIX);
